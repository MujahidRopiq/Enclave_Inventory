                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            ...
                            <div class="card-tools">
                                <a href="/invoice_selects" class="btn btn-sm btn-success">Add invoice</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table class="table table-hover text-nowrap">
                                <thead>
                                    <tr class="bg-dark">
                                        ...
                                        <th class="text-right">Consignee</th>
                                ...
                                <tbody>
                                    @foreach ($invoices as $data)
                                        <tr>
                                            ...
                                            <td class="text-right">{{ $data->consignee }}</td>
    ...
    @foreach ($invoices as $data)
        <div class="modal fade" id="status-{{ $data->id }}">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <form action="/invoices/{{ $data->id }}" method="post">
                        @csrf
                        @method('put')
                        <div class="modal-body mt-5">
                            {{-- <div>
