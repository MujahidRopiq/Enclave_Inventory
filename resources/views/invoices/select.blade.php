                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            <div class="card-tools">
                                <a href="/invoices" class="btn btn-danger btn-sm">Batal</a>
                                <a href="/invoices/create" class="btn btn-sm btn-success ml-1">Lanjut</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    @foreach ($invoice_selects as $data)
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <form
                                                    action="/invoice_selects/{{ $data->id }}{{ str_replace('/invoice_selects', '', request()->getRequestUri()) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                ...
                                <tbody>
                                    @foreach ($furnitures as $data)
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <form
                                                    action="/invoice_selects{{ str_replace('/invoice_selects', '', request()->getRequestUri()) }}"
                                                    method="post">
                                                    @csrf
    ...
    <div class="modal fade" id="all-filter">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="/invoice_selects" method="get">
