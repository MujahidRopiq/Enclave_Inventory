                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            ...
                            <div class="card-tools">
                                <a href="/material1s/create{{ str_replace('/material1s', '', request()->getRequestUri()) }}"
                                    ...
                                    @foreach ($material1s as $data)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ count($data->furnitures) }}<a
                                                    href="/furnitures?material1={{ $data->name }}"
                                            ...
                                            <td class="project-actions text-right">
                                                <div class="d-flex justify-content-end">
                                                    <a class="btn btn-info btn-sm mr-1"
                                                        href="/material1s/{{ $data->id }}/edit{{ str_replace('/material1s', '', request()->getRequestUri()) }}">
                                                        <i class="fas fa-pencil-alt"> </i>
                                                        Ubah
                                                    </a>
                                                    <form
                                                        action="/material1s/{{ $data->id . str_replace('/material1s', '', request()->getRequestUri()) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button
    ...
    <div class="modal fade" id="all-filter">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="/material1s" method="get">
