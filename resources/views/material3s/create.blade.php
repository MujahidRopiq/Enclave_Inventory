...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Horizontal Form -->
            <form action="/material3s" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="card">
                    <div class="bg-dark card-header">
                        <h3 class="card-title">Form Tambah Material 3</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end">
                            <a href="/material3s{{ str_replace('/material3s/create', '', request()->getRequestUri()) }}"
