...
<body>
  ...
  <div class="flex items-top p-10 px-24 pt-40">
      <div class="w-full">
        <h1 class="font-bold text-3xl mb-1">Sign Up</h1>
        ...
        @endif
        <form action="{{ route('register') }}" method="post" class="mt-8 w-full">
        @csrf
          <div class="space-y-4 mb-6">
            <div class="">
              <label class="font-medium">Name</label>
              <input type="text" name="name" class="block w-full rounded-md border p-1" required/>
            </div>
            <div class="">
          ...
          <div class="grid grid-cols-[160px_1fr]">
            <div class="flex items-center justify-between">
              <a href="/login" class="font-bold text-gray-500 text-sm hover:underline hover:text-red-300">Login Page</a>
            </div>
            <button type="submit" class="bg-red-900 text-white w-full py-1 rounded-md hover:bg-red-700">Register</button>
          </div>
