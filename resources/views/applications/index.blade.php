                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            ...
                            <div class="card-tools">
                                <a href="/applications/create{{ str_replace('/applications', '', request()->getRequestUri()) }}"
                                    class="btn btn-sm btn-success">Add application</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                            ...
                                            <td class="project-actions text-right">
                                                <div class="d-flex justify-content-end">
                                                    <a class="btn btn-info btn-sm mr-1"
                                                        href="/applications/{{ $data->id }}/edit{{ str_replace('/applications', '', request()->getRequestUri()) }}">
                                                        <i class="fas fa-pencil-alt"> </i>
                                                        Ubah
                                                    </a>
                                                    <form
                                                        action="/applications/{{ $data->id . str_replace('/applications', '', request()->getRequestUri()) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button
