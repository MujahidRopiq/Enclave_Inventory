                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            ...
                            <div class="card-tools">
                                <a href="/categories/create{{ str_replace('/categories', '', request()->getRequestUri()) }}"
                                    ...
                                    @foreach ($categories as $data)
                                        <tr>
                                            ...
                                            <td class="text-right">{{ count($data->furnitures) }} <a
                                                    href="/furnitures?catergory={{ $data->name }}"
                                            ...
                                            <td class="project-actions text-right">
                                                <div class="d-flex justify-content-end">
                                                    <a class="btn btn-info btn-sm mr-1"
                                                        href="/categories/{{ $data->id }}/edit{{ str_replace('/categories', '', request()->getRequestUri()) }}">
                                                        <i class="fas fa-pencil-alt"> </i>
                                                        Ubah
                                                    </a>
                                                    <form
                                                        action="/categories/{{ $data->id . str_replace('/categories', '', request()->getRequestUri()) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button
