...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Horizontal Form -->
            <form action="/material2s" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="card">
                    <div class="bg-dark card-header">
                        <h3 class="card-title">Form Tambah Material 2</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end">
                            <a href="/material2s{{ str_replace('/material2s/create', '', request()->getRequestUri()) }}"
