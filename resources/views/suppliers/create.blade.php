                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" min="0" name="phone"
                                    ...
                                    placeholder="phone" value="{{ old('phone') }}" autofocus autocomplete="off" required>
                                @error('phone')
                                    <small class="text-danger font-italic">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="company"
                                    ...
                                    placeholder="company" value="{{ old('company') }}" autofocus autocomplete="off">
                                @error('company')
                                    <small class="text-danger font-italic">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="address"
                                    ...
                                    placeholder="address" value="{{ old('address') }}" autofocus autocomplete="off">
                                @error('address')
                                    <small class="text-danger font-italic">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('skill') is-invalid @enderror" rows="3" name="skill" id="skill"
                                    placeholder="skill...">{{ old('skill') }}</textarea>
                                @error('skill')
                                    <small class="text-danger font-italic">{{ $message }}</small>
                                @enderror
                            </div>
